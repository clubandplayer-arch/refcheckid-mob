...
CREATE TABLE photo_approvals (
    ...
    CONSTRAINT fk_photo_approvals_registration FOREIGN KEY (registration_id) REFERENCES player_registrations (id),
...
CREATE TABLE season_registration_photos (
    ...
    CONSTRAINT fk_season_registration_photos_registration FOREIGN KEY (registration_id) REFERENCES player_registrations (id),
...
CREATE TABLE match_sheet_photo_snapshots (
    ...
    CONSTRAINT fk_match_sheet_photo_snapshots_registration FOREIGN KEY (registration_id) REFERENCES player_registrations (id),
...
CREATE TABLE photo_audit_events (
    ...
    CONSTRAINT fk_photo_audit_events_registration FOREIGN KEY (registration_id) REFERENCES player_registrations (id),
